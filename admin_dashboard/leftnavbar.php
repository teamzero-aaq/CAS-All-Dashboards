  ...
  <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
              <li class="nav-item nav-profile">
                  <a href="#" class="nav-link">
                      ...
                      <div class="nav-profile-text d-flex flex-column">
                          ...
                          <span class="text-secondary text-small">Committee</span>
                      </div>
              ...
              <li class="nav-item">
                  <a class="nav-link" href="edit_access_req.php">
              ...
              <li class="nav-item sidebar-actions">
                  <a href="create_users.php" class="btn-link"><button class="btn btn-lg btn-gradient-primary">
                          + Create
                          User
                      </button></a>
              </li>
