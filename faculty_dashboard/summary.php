    ...
    <div class="content-wrapper">
        ...
        <div class="row mt-5">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <p class="mt-4 text-center">List of Enclosures: (Please attach copies of certificates, sanction
                            orders,
                        ...
                        <p class="mt-4 mb-4 text-center"><button
                                class="btn btn-danger mt-2 align-items-center">Print</button></p>
