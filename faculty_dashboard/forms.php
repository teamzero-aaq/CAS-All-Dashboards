                                        ...
                                        <table class="table table-bordered table-responsive" id="tbl_posts2">
                                            ...
                                            <tbody id="tbl_posts_body2">
                                                <tr id="rec2-1">
                                                    ...
                                                    <td> <input type="file" name="img[]" class="form-control" id=""
                                                            name="" /></td>
                                ...
                                <div class="row">
                                            ...
                                            <tbody id="tbl_posts_body7">
                                                <tr id="rec7-1">
                                                    ...
                                                    <td> <textarea name='' id="" value=""
                                                            ...
                                                            class="form-control"></textarea></td>
                                                    <td> <textarea name='' id="" value="" placeholder="ISSN/ISBN No."
                                                            class="form-control"></textarea></td>
                                                    <td><input type="text" name="" id="" value=""
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-6">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio"
                                                                            class="form-check-input rbtn" name="radio-1"
                                                                            id="membershipRadios1" value="" checked> Yes
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio"
                                                                            class="form-check-input rbtn" name="radio-1"
                                                                            id="membershipRadios2" value="option2"> No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="hide">
                                        <table id="sample_table7">
                                            <tr id="">
                                                <td><span class="sn">1</span>.</td>
                                                <td> <textarea name='' id="" value="" placeholder="Title with page no"
                                                        class="form-control"></textarea></td>
                                                <td> <textarea name='' id="" value=""
                                                        placeholder="Name of peer review Journals (not online journals)"
                                                        class="form-control"></textarea></td>
                                                ...
                                                <td>
                                                    <div class="form-group row">
                                                        <div class="col-sm-6">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input rbtn"
                                                                        name="" id="membershipRadios1" value="" checked>
                                                                    Yes </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input rbtn"
                                                                        name="" id="membershipRadios2" value="option2">
                                                                    No </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-sm-6">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio"
                                                                            class="form-check-input rbtn" name="radio1"
                                                                            id="membershipRadios3" value="" checked> Yes
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio"
                                                                            class="form-check-input rbtn" name="radio1"
                                                                            id="membershipRadios4" value="option2"> No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input rbtn"
                                                                        name="" id="membershipRadios3" value="" checked>
                                                                    Yes </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input rbtn"
                                                                        name="" id="membershipRadios4" value="option2">
                                                                    No </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio"
                                                                            ...
                                                                            name="radio9-1" id="membershipRadios5"
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio"
                                                                            class="form-check-input rbtn"
                                                                            name="radio9-1" id="membershipRadios6"
                                                                            value="option2"> No </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input rbtn"
                                                                        name="" id="membershipRadios5" value="" checked>
                                                                    Yes </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input rbtn"
                                                                        name="" id="membershipRadios6" value="option2">
                                                                    No </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <tbody id="tbl_posts_body10">
                                                <tr id="rec10-1">
                                                    ...
                                                    <td> <textarea name='' id="" value=""
                                                            placeholder="Title with page no"
                                                            class="form-control"></textarea></td>
                                                    <td> <textarea name='' id="" value="" placeholder="Publisher"
                                                            class="form-control"></textarea></td>
                                                    <td> <textarea name='' id="" value="" placeholder="ISSN/ISBN No."
                                                            class="form-control"></textarea></td>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio"
                                                                            class="form-check-input rbtn"
                                                                            name="radio10-1" id="membershipRadios7"
                                                                            value="" checked> Yes </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-check">
                                                                    <label class="form-check-label">
                                                                        <input type="radio"
                                                                            class="form-check-input rbtn"
                                                                            name="radio10-1" id="membershipRadios8"
                                                                            value="option2"> No </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input rbtn"
                                                                        name="" id="membershipRadios7" value="" checked>
                                                                    Yes </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input rbtn"
                                                                        name="" id="membershipRadios8" value="option2">
                                                                    No </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <table class="table table-bordered table-responsive">
                                            ...
                                            <tbody id="">
                                                <tr id="">
                                                    ...
                                                    <td><input type="text" name="" id="" value="" placeholder="Self"
                                                            class="form-control"></td>
                                                    <td><input type="text" name="" id="" value="" placeholder="H.O.D "
                                                            class="form-control"></td>
                                                    <td><input type="text" name="" id="" value=""
                                                            placeholder="Committee" class="form-control"></td>
                                                    <td> <input type="file" name="img[]" class="form-control"
