            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-center">2. Final Verification and Evaluation in respects of PI by committee
                        </p>
                        ...
                        <table class="table table-bordered table-responsive">
                            ...
                            <tbody class="text-center">
                                ...
                                <tr>
                                    <td>Part A </td>
                                    <td><input type="text" name='' id="" value="" placeholder=""
                                ...
                                <td>Average PI</td>
                                <td colspan="3"><input type="text" name='' id="" value="" placeholder=""
                                        class="form-control form-control-sm"></td>
                                <td colspan="3"><input type="text" name='' id="" value="" placeholder=""
                                        class="form-control form-control-sm"></td>
                                <td colspan="3"><input type="text" name='' id="" value="" placeholder=""
                    ...
                    <div class="card-body">
                        <form action="">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Final Remarks by Committee:</label>
                                        <div class="col-sm-9">
                                            <textarea name="" class="form-control" id="" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Action for CAS </label>
                                <div class="col-sm-4">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="membershipRadios"
                                                id="membershipRadios1" value="" checked> Approve for CAS</label>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="membershipRadios"
                                                id="membershipRadios2" value="option2"> Disapprove for CAS </label>
                                    </div>
                                </div>
                            </div>
                            <button type="button" class="btn btn-secondary mb-2">Print</button>
